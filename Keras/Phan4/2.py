...
def read_from_file():
    with open('C:/Users/Administrator/Duong/Python/Keras/Phan4/capital_data.txt') as file:
        for line in file:
            line = line.rstrip('\n')
...
def write_to_file(country_name, city_name):
    with open('C:/Users/Administrator/Duong/Python/Keras/Phan4/capital_data.txt', 'a') as file:
