...
def main():
	...
	def file_selector(folder_path=r'C:\Users\Administrator\Duong\Python\StreamLit\Dataset\datasets'):
	...
	if st.checkbox("Show Dataset"):
		st.number_input("Number of Rows to View")
	...
	st.sidebar.info("Duong Saves@DuongTeacher")
	st.sidebar.text("Built with Streamlit")
	st.sidebar.text("Maintained by Steve")
